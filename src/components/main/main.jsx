        ...
        <form className=" converter__form converter-form">
          <fieldset className="converter-form__group converter-form__group--i-have">
            ...
            <div className="converter-form__wrapper">
              <input className="converter-form__input converter-form__input--i-have" type="number" min="0"   max="1000"></input>
          ...
          <fieldset className="converter-form__group converter-form__group--i-want">
            ...
            <div className="converter-form__wrapper">
              <input className="converter-form__input converter-form__input--i-want" type="number" min="0" max="1000"></input>
          ...
          <input className="converter-form__input converter-form__input--date" type="date"></input>
          <button className="converter-form__submit button">Сохранить результат</button>
        </form>
          <section className="converter-history">
            ...
            <div className="converter-history__table">
              <div className="converter-history__column">
                <div className="converter-history__row">
                  <span className="converter-history__date">25.11.2020</span>
                  <span className="converter-history__from">1000 RUB</span>
                  <span className="converter-history__to">13,1 USD</span>
                </div>
                <div className="converter-history__row">
                  <span className="converter-history__date">25.11.2020</span>
                  <span className="converter-history__from">1000 RUB</span>
                  <span className="converter-history__to">13,1234 USD</span>
                </div>
                <div className="converter-history__row">
                  <span className="converter-history__date">25.11.2020</span>
                  <span className="converter-history__from">1000 RUB</span>
              ...
              <div className="converter-history__column">
                ...
                <div className="converter-history__row">
                  <span className="converter-history__date">25.11.2020</span>
                  <span className="converter-history__from">1000 RUB</span>
                  <span className="converter-history__to">13,12 USD</span>
                </div>
                <div className="converter-history__row">
                  <span className="converter-history__date">25.11.2020</span>
                  <span className="converter-history__from">1000 RUB</span>
            ...
            <button className="converter-history__clear button">Очистить историю</button>
          </section>
      </div>
    </main>
      ...
      <div className="footer__container container">
        <div className="footer__column footer__column--left">
          <a className="footer__link-logo" href="/">
            <img width="149px" height="25px" src="./img/logo.png" alt="Логотип Лига Банк"></img>
          </a>
        ...
        <ul className="footer__column footer-nav">
        ...
        <div className="footer__column footer__column--padding-left footer__column--mobile">
        ...
        <div className="footer__column footer__column--padding-left footer__column--landline-phone">
        ...
        <ul className="footer__column footer-socials">
          <li className="footer-socials__item">
            <a className="footer-socials__facebook" href="/">
              <svg className="footer-socials__icon" width="9" height="16" viewBox="0 0 9 16">
